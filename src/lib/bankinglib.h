...
#define GUI_INPUT_PASSWORD_SIGNIN 2
#define GUI_INPUT_PASSWORD_LOGIN  3
#define GUI_INPUT_FIRSTNAME       4
#define GUI_INPUT_LASTNAME        5
#define GUI_INPUT_MIDNAME         6
#define GUI_INPUT_STREET          7
#define GUI_INPUT_BARANGAY        8
#define GUI_INPUT_CITY            9
#define GUI_INPUT_REGION          10
#define GUI_INPUT_POSTALCODE      11
#define GUI_INPUT_WITHDRAWBALANCE 12
#define GUI_INPUT_DEPOSITBALANCE  13
